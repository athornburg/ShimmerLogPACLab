...
package io.pacmonitorandroid.app.google.cloud.model;
...
public final class QueryDto extends com.google.api.client.json.GenericJson {
   ...
   */
  public QueryDto setKindName(String kindName) {
   ...
   */
  public QueryDto setQueryId(String queryId) {
   ...
   */
  public QueryDto setRegId(String regId) {
    this.regId = regId;
    return this;
  }
   ...
   */
  public QueryDto setScope(String scope) {
    this.scope = scope;
    return this;
  }
   ...
   */
  public QueryDto setSortAscending(Boolean sortAscending) {
   ...
   */
  public QueryDto setSortedPropertyName(String sortedPropertyName) {
   ...
   */
  public QueryDto setSubscriptionDurationSec(Integer subscriptionDurationSec) {
