...
package io.pacmonitorandroid.app.google.cloud;
...
public class Mobilebackend extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class BlobEndpoint {
     ...
     * @return the request
     */
    public DeleteBlob deleteBlob(String bucketName, String objectPath) throws java.io.IOException {
    ...
    public class DeleteBlob extends MobilebackendRequest<Void> {
       ...
       * @since 1.13
       */
      protected DeleteBlob(String bucketName, String objectPath) {
      ...
      @Override
      public DeleteBlob setAlt(String alt) {
        return (DeleteBlob) super.setAlt(alt);
      }

      @Override
      public DeleteBlob setFields(String fields) {
        return (DeleteBlob) super.setFields(fields);
      }

      @Override
      public DeleteBlob setKey(String key) {
        return (DeleteBlob) super.setKey(key);
      }

      @Override
      public DeleteBlob setOauthToken(String oauthToken) {
        return (DeleteBlob) super.setOauthToken(oauthToken);
      }

      @Override
      public DeleteBlob setPrettyPrint(Boolean prettyPrint) {
        return (DeleteBlob) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public DeleteBlob setQuotaUser(String quotaUser) {
        return (DeleteBlob) super.setQuotaUser(quotaUser);
      }

      @Override
      public DeleteBlob setUserIp(String userIp) {
      ...
      public DeleteBlob setBucketName(String bucketName) {
      ...
      public DeleteBlob setObjectPath(String objectPath) {
     ...
     * @return the request
     */
    public GetDownloadUrl getDownloadUrl(String bucketName, String objectPath) throws java.io.IOException {
      GetDownloadUrl result = new GetDownloadUrl(bucketName, objectPath);
      initialize(result);
      return result;
    }

    public class GetDownloadUrl extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.BlobAccess> {
       ...
       * @since 1.13
       */
      protected GetDownloadUrl(String bucketName, String objectPath) {
        super(Mobilebackend.this, "GET", REST_PATH, null, io.pacmonitorandroid.app.google.cloud.model.BlobAccess.class);
        this.bucketName = com.google.api.client.util.Preconditions.checkNotNull(bucketName, "Required parameter bucketName must be specified.");
        this.objectPath = com.google.api.client.util.Preconditions.checkNotNull(objectPath, "Required parameter objectPath must be specified.");
      }
      ...
      @Override
      public GetDownloadUrl setAlt(String alt) {
        return (GetDownloadUrl) super.setAlt(alt);
      }

      @Override
      public GetDownloadUrl setFields(String fields) {
        return (GetDownloadUrl) super.setFields(fields);
      }

      @Override
      public GetDownloadUrl setKey(String key) {
        return (GetDownloadUrl) super.setKey(key);
      }

      @Override
      public GetDownloadUrl setOauthToken(String oauthToken) {
        return (GetDownloadUrl) super.setOauthToken(oauthToken);
      }

      @Override
      public GetDownloadUrl setPrettyPrint(Boolean prettyPrint) {
        return (GetDownloadUrl) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public GetDownloadUrl setQuotaUser(String quotaUser) {
        return (GetDownloadUrl) super.setQuotaUser(quotaUser);
      }

      @Override
      public GetDownloadUrl setUserIp(String userIp) {
      ...
      public GetDownloadUrl setBucketName(String bucketName) {
        this.bucketName = bucketName;
        return this;
      }
      ...
      public GetDownloadUrl setObjectPath(String objectPath) {
        this.objectPath = objectPath;
        return this;
      }
     ...
     * @return the request
     */
    public GetUploadUrl getUploadUrl(String bucketName, String objectPath, String accessMode) throws java.io.IOException {
      GetUploadUrl result = new GetUploadUrl(bucketName, objectPath, accessMode);
      initialize(result);
      return result;
    }

    public class GetUploadUrl extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.BlobAccess> {
       ...
       * @since 1.13
       */
      protected GetUploadUrl(String bucketName, String objectPath, String accessMode) {
        super(Mobilebackend.this, "GET", REST_PATH, null, io.pacmonitorandroid.app.google.cloud.model.BlobAccess.class);
        this.bucketName = com.google.api.client.util.Preconditions.checkNotNull(bucketName, "Required parameter bucketName must be specified.");
        this.objectPath = com.google.api.client.util.Preconditions.checkNotNull(objectPath, "Required parameter objectPath must be specified.");
      ...
      @Override
      public GetUploadUrl setAlt(String alt) {
        return (GetUploadUrl) super.setAlt(alt);
      }

      @Override
      public GetUploadUrl setFields(String fields) {
        return (GetUploadUrl) super.setFields(fields);
      }

      @Override
      public GetUploadUrl setKey(String key) {
        return (GetUploadUrl) super.setKey(key);
      }

      @Override
      public GetUploadUrl setOauthToken(String oauthToken) {
        return (GetUploadUrl) super.setOauthToken(oauthToken);
      }

      @Override
      public GetUploadUrl setPrettyPrint(Boolean prettyPrint) {
        return (GetUploadUrl) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public GetUploadUrl setQuotaUser(String quotaUser) {
        return (GetUploadUrl) super.setQuotaUser(quotaUser);
      }

      @Override
      public GetUploadUrl setUserIp(String userIp) {
      ...
      public GetUploadUrl setBucketName(String bucketName) {
        this.bucketName = bucketName;
        return this;
      }
      ...
      public GetUploadUrl setObjectPath(String objectPath) {
        this.objectPath = objectPath;
        return this;
      }
      ...
      public GetUploadUrl setAccessMode(String accessMode) {
      ...
      public GetUploadUrl setContentType(String contentType) {
  ...
  public class EndpointV1 {
     ...
     * @return the request
     */
    public Delete delete(String kind, String id) throws java.io.IOException {
      Delete result = new Delete(kind, id);
      initialize(result);
      return result;
    }

    public class Delete extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityDto> {
       ...
       * @since 1.13
       */
      protected Delete(String kind, String id) {
        super(Mobilebackend.this, "DELETE", REST_PATH, null, io.pacmonitorandroid.app.google.cloud.model.EntityDto.class);
     ...
     *
     * @param content the {@link io.pacmonitorandroid.app.google.cloud.model.EntityListDto}
     * @return the request
     */
    public DeleteAll deleteAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) throws java.io.IOException {
      DeleteAll result = new DeleteAll(content);
      initialize(result);
      return result;
    }

    public class DeleteAll extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityListDto> {
       ...
       * @since 1.13
       */
      protected DeleteAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityListDto.class);
      }
     ...
     * @return the request
     */
    public Get get(String kind, String id) throws java.io.IOException {
      Get result = new Get(kind, id);
      initialize(result);
      return result;
    }

    public class Get extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityDto> {
       ...
       * @since 1.13
       */
      protected Get(String kind, String id) {
        super(Mobilebackend.this, "GET", REST_PATH, null, io.pacmonitorandroid.app.google.cloud.model.EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
      ...
      public Get setKind(String kind) {
        this.kind = kind;
        return this;
      }
     ...
     * @return the request
     */
    public GetAll getAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) throws java.io.IOException {
      GetAll result = new GetAll(content);
      initialize(result);
      return result;
    }

    public class GetAll extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityListDto> {
       ...
       * @since 1.13
       */
      protected GetAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityListDto.class);
      }

      @Override
      public GetAll setAlt(String alt) {
        return (GetAll) super.setAlt(alt);
      }

      @Override
      public GetAll setFields(String fields) {
        return (GetAll) super.setFields(fields);
      }

      @Override
      public GetAll setKey(String key) {
        return (GetAll) super.setKey(key);
      }

      @Override
      public GetAll setOauthToken(String oauthToken) {
        return (GetAll) super.setOauthToken(oauthToken);
      }

      @Override
      public GetAll setPrettyPrint(Boolean prettyPrint) {
        return (GetAll) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public GetAll setQuotaUser(String quotaUser) {
        return (GetAll) super.setQuotaUser(quotaUser);
      }

      @Override
      public GetAll setUserIp(String userIp) {
     ...
     *
     * @param kind
     * @param content the {@link io.pacmonitorandroid.app.google.cloud.model.EntityDto}
     * @return the request
     */
    public Insert insert(String kind, io.pacmonitorandroid.app.google.cloud.model.EntityDto content) throws java.io.IOException {
      Insert result = new Insert(kind, content);
      initialize(result);
      return result;
    }

    public class Insert extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityDto> {
       ...
       * @since 1.13
       */
      protected Insert(String kind, io.pacmonitorandroid.app.google.cloud.model.EntityDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
      }
      ...
      public Insert setKind(String kind) {
        this.kind = kind;
        return this;
      }
     ...
     * @return the request
     */
    public InsertAll insertAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) throws java.io.IOException {
      InsertAll result = new InsertAll(content);
      initialize(result);
      return result;
    }

    public class InsertAll extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityListDto> {
       ...
       * @since 1.13
       */
      protected InsertAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityListDto.class);
      }
     ...
     *
     * @param content the {@link io.pacmonitorandroid.app.google.cloud.model.QueryDto}
     * @return the request
     */
    public List list(io.pacmonitorandroid.app.google.cloud.model.QueryDto content) throws java.io.IOException {
      List result = new List(content);
      initialize(result);
      return result;
    }

    public class List extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityListDto> {
       ...
       * @since 1.13
       */
      protected List(io.pacmonitorandroid.app.google.cloud.model.QueryDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityListDto.class);
      }
     ...
     * @return the request
     */
    public Patch patch(String kind, String id, io.pacmonitorandroid.app.google.cloud.model.EntityDto content) throws java.io.IOException {
      Patch result = new Patch(kind, id, content);
      initialize(result);
      return result;
    }

    public class Patch extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityDto> {
       ...
       * @since 1.13
       */
      protected Patch(String kind, String id, io.pacmonitorandroid.app.google.cloud.model.EntityDto content) {
        super(Mobilebackend.this, "PATCH", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
        this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
      }
      ...
      public Patch setKind(String kind) {
        this.kind = kind;
        return this;
      }
     ...
     * @return the request
     */
    public Update update(String kind, io.pacmonitorandroid.app.google.cloud.model.EntityDto content) throws java.io.IOException {
      Update result = new Update(kind, content);
      initialize(result);
      return result;
    }

    public class Update extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityDto> {
       ...
       * @since 1.13
       */
      protected Update(String kind, io.pacmonitorandroid.app.google.cloud.model.EntityDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityDto.class);
        this.kind = com.google.api.client.util.Preconditions.checkNotNull(kind, "Required parameter kind must be specified.");
      }
      ...
      public Update setKind(String kind) {
        this.kind = kind;
        return this;
      }
     ...
     * @return the request
     */
    public UpdateAll updateAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) throws java.io.IOException {
      UpdateAll result = new UpdateAll(content);
      initialize(result);
      return result;
    }

    public class UpdateAll extends MobilebackendRequest<io.pacmonitorandroid.app.google.cloud.model.EntityListDto> {
       ...
       * @since 1.13
       */
      protected UpdateAll(io.pacmonitorandroid.app.google.cloud.model.EntityListDto content) {
        super(Mobilebackend.this, "POST", REST_PATH, content, io.pacmonitorandroid.app.google.cloud.model.EntityListDto.class);
      }

      @Override
      public UpdateAll setAlt(String alt) {
        return (UpdateAll) super.setAlt(alt);
      }

      @Override
      public UpdateAll setFields(String fields) {
        return (UpdateAll) super.setFields(fields);
      }

      @Override
      public UpdateAll setKey(String key) {
        return (UpdateAll) super.setKey(key);
      }

      @Override
      public UpdateAll setOauthToken(String oauthToken) {
        return (UpdateAll) super.setOauthToken(oauthToken);
      }

      @Override
      public UpdateAll setPrettyPrint(Boolean prettyPrint) {
        return (UpdateAll) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public UpdateAll setQuotaUser(String quotaUser) {
        return (UpdateAll) super.setQuotaUser(quotaUser);
      }

      @Override
      public UpdateAll setUserIp(String userIp) {
