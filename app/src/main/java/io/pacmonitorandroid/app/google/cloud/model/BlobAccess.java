...
public final class BlobAccess extends com.google.api.client.json.GenericJson {
   ...
   */
  public BlobAccess setAccessUrl(String accessUrl) {
   ...
   */
  public BlobAccess setMandatoryHeaders(String mandatoryHeaders) {
   ...
   */
  public BlobAccess setShortLivedUrl(String shortLivedUrl) {
