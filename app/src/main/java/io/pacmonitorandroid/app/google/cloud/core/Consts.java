...
public interface Consts {
     ...
     */
    public static final String PROJECT_ID = "handy-reference-545";

    /**
     * Set Project Number of your Google APIs Console Project.
     */
    public static final String PROJECT_NUMBER = "947084898836";

    /**
     * Set your Web Client ID for authentication at backend.
     */
    public static final String WEB_CLIENT_ID = "947084898836.apps.googleusercontent.com";
