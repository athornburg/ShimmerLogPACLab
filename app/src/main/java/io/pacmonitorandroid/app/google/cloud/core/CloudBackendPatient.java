...
package io.pacmonitorandroid.app.google.cloud.core;

import android.content.Context;
import android.content.SharedPreferences;

import com.google.api.client.util.DateTime;
import io.pacmonitorandroid.app.google.cloud.core.CloudQuery.Order;
import io.pacmonitorandroid.app.google.cloud.core.CloudQuery.Scope;
import io.pacmonitorandroid.app.tools.SensorData;
 ...
 */
public class CloudBackendPatient extends CloudBackendAsync {
     ...
     */
    public CloudBackendPatient(Context context) {
        super(context);
    }
     ...
     */
    public static final String KIND_NAME_PATIENTS = "PatientData";
    ...
    private CloudQuery createQueryForCloudMessage(String topicId, int maxOfflineMessages) {
        ...
        // create query
        CloudQuery cq = new CloudQuery(KIND_NAME_PATIENTS);
    ...
    private class CloudMessageHandler extends CloudCallbackHandler<List<CloudEntity>> {
        private CloudBackendPatient backend;

        public CloudMessageHandler(CloudBackendPatient backend) {
     ...
     * @return
     */
    public CloudEntity createPatient(SensorData data) {
        CloudEntity ce = new CloudEntity(KIND_NAME_PATIENTS);
