...
public final class EntityDto extends com.google.api.client.json.GenericJson {
   ...
   */
  public EntityDto setCreatedBy(String createdBy) {
   ...
   */
  public EntityDto setKindName(String kindName) {
   ...
   */
  public EntityDto setOwner(String owner) {
    this.owner = owner;
    return this;
  }
   ...
   */
  public EntityDto setProperties(Object properties) {
   ...
   */
  public EntityDto setUpdatedBy(String updatedBy) {
