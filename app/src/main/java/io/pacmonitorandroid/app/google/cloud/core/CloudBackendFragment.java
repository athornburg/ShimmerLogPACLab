...
import io.pacmonitorandroid.app.google.cloud.gcm.GCMIntentService;
...
public class CloudBackendFragment extends Fragment {
    ...
    private CloudBackendPatient mCloudBackend;
    ...
    /**
     * Returns {@link CloudBackendPatient} instance for this activity.
     *
     * @return {@link CloudBackendPatient}
     */
    public CloudBackendPatient getCloudBackend() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // init backend
        mCloudBackend = new CloudBackendPatient(getActivity());
    ...
    private void subscribeToBroadcast() {
        ...
        mCloudBackend.subscribeToCloudMessage(
                CloudBackendPatient.TOPIC_ID_BROADCAST, handler);
